...
let LoginForm = class LoginForm extends vue_property_decorator__WEBPACK_IMPORTED_MODULE_0__["Vue"] {
    ...
    login() {
        this.loading = true;
        Object(_api_auth_login__WEBPACK_IMPORTED_MODULE_1__["default"])({ email: this.email.model, password: this.password.model })
            .then(response => {
            ...
            .catch(error => {
            this.loading = false;
            const err = Object(_api_http__WEBPACK_IMPORTED_MODULE_3__["httpErrorToHuman"])(error);
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("v-card-subtitle", [_c("p", [_vm._v("Sign in to continue")])]),
      _vm._v(" "),
      _c(
        "v-card-text",
        [
          _c("v-text-field", {
            ...
            model: {
              value: _vm.email.model,
              callback: function($$v) {
                _vm.$set(_vm.email, "model", $$v)
              },
              expression: "email.model"
            }
          }),
          _vm._v(" "),
          _c("v-text-field", {
            attrs: {
              ...
              type: _vm.password.hidden ? "password" : "text",
              "append-icon": _vm.password.hidden
                ? "mdi-eye-outline"
                : "mdi-eye-off-outline",
              required: ""
            },
            on: {
              "click:append": function() {
                return (_vm.password.hidden = !_vm.password.hidden)
              }
            },
            model: {
              value: _vm.password.model,
              callback: function($$v) {
                _vm.$set(_vm.password, "model", $$v)
              },
              expression: "password.model"
            }
          })
        ],
        1
