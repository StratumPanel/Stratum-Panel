<?php
namespace Stratum\Console\Commands\Generators\Repository;
...
class RepositoryEloquentGenerator extends Generator
{
    ...
    {
        $repository = parent::getRootNamespace() . parent::getConfigGeneratorClassPath('interfaces') . '\\' . $this->name . 'RepositoryInterface';
